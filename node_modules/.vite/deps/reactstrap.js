import {
  ...
  _setPrototypeOf
} from "./chunk-F3LIOUVD.js";
import {
  _extends
} from "./chunk-PJB4W5XK.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-QBYM2J42.js";
import {
  require_prop_types
} from "./chunk-YRE56OLT.js";
import "./chunk-UC4PJN3B.js";
import {
  Manager,
  Popper,
  Reference
} from "./chunk-E7MVDCFY.js";
import "./chunk-EJSJ2JH7.js";
import {
  require_react_dom
} from "./chunk-OE2T44GN.js";
import {
  require_react
} from "./chunk-WAJ3NY2E.js";
import {
  require_classnames
} from "./chunk-BV5VBAQ2.js";
import {
  __commonJS,
  __export,
  __toESM,
...
function addDefaultProps(defaultProps14, props) {
  if (!defaultProps14 || !props)
    return props;
  var result = _objectSpread({}, props);
  Object.keys(defaultProps14).forEach(function(key) {
    if (result[key] === void 0) {
      result[key] = defaultProps14[key];
    }
    if (Object.keys(defaultProps14[key] || {}).length > 0 && _typeof(defaultProps14[key]) === "object") {
      addDefaultProps(defaultProps14[key], result);
    }
  });
  return result;
}
...
var getColumnClasses = function getColumnClasses2(attributes, cssModule) {
  ...
  widths.forEach(function(colWidth, i) {
    ...
    if (isObject(columnProp)) {
      ...
      colClasses.push(mapToCssModules((0, import_classnames3.default)((_classNames = {}, _defineProperty2(_classNames, colClass, columnProp.size || columnProp.size === ""), _defineProperty2(_classNames, "order".concat(colSizeInterfix).concat(columnProp.order), columnProp.order || columnProp.order === 0), _defineProperty2(_classNames, "offset".concat(colSizeInterfix).concat(columnProp.offset), columnProp.offset || columnProp.offset === 0), _classNames)), cssModule));
    } else {
...
function Navbar(props) {
  ...
  var classes = mapToCssModules((0, import_classnames4.default)(className, "navbar", getExpandClass(expand), (_classNames = {
    "navbar-light": light,
    "navbar-dark": dark
  }, _defineProperty3(_classNames, "bg-".concat(color), color), _defineProperty3(_classNames, "fixed-".concat(fixed), fixed), _defineProperty3(_classNames, "sticky-".concat(sticky), sticky), _classNames)), cssModule);
  ...
  _createClass2(Dropdown2, [{
    ...
    value: function render() {
      ...
      var classes = mapToCssModules((0, import_classnames16.default)(className, nav && active ? "active" : false, setActiveFromChild && subItemIsActive ? "active" : false, (_classNames = {
        "btn-group": group
      }, _defineProperty6(_classNames, "btn-group-".concat(size), !!size), _defineProperty6(_classNames, "dropdown", !group), _defineProperty6(_classNames, "dropup", direction === "up"), _defineProperty6(_classNames, "dropstart", direction === "start" || direction === "left"), _defineProperty6(_classNames, "dropend", direction === "end" || direction === "right"), _defineProperty6(_classNames, "show", isOpen), _defineProperty6(_classNames, "nav-item", nav), _classNames)), cssModule);
      ...
      return import_react18.default.createElement(DropdownContext.Provider, {
        value: this.getContextValue()
      }, import_react18.default.createElement(Manager, null, import_react18.default.createElement(Tag, _extends17({}, attrs, _defineProperty6({}, typeof Tag === "string" ? "ref" : "innerRef", this.containerRef), {
...
function ButtonGroup(props) {
  ...
  return import_react20.default.createElement(Tag, _extends19({}, _objectSpread4({
    role: "group"
  }, attributes), {
    className: classes
  }));
...
function ButtonToolbar(props) {
  ...
  return import_react21.default.createElement(Tag, _extends20({}, _objectSpread5({
    role: "toolbar"
  }, attributes), {
    className: classes
  }));
    ...
    value: function render() {
      ...
      if (persist || this.context.isOpen && !this.context.inNavbar) {
        ...
        var popper = import_react23.default.createElement(Popper, {
          ...
          var combinedStyle = _objectSpread6(_objectSpread6(_objectSpread6({}, _this.props.style), persistStyles), style);
  ...
  _createClass5(DropdownToggle2, [{
    ...
    value: function render() {
      ...
      var returnFunction = function returnFunction2(_ref) {
        ...
        return import_react24.default.createElement(Tag, _extends23({}, props, _defineProperty10({}, typeof Tag === "string" ? "ref" : "innerRef", handleRef), {
          className: classes,
...
var propTypes23 = _objectSpread7(_objectSpread7({}, Transition_default.propTypes), {}, {
...
var defaultProps4 = _objectSpread7(_objectSpread7({}, Transition_default.defaultProps), {}, {
...
function Fade(props) {
  ...
  var _addDefaultProps = addDefaultProps(defaultProps4, props), _addDefaultProps$tag = _addDefaultProps.tag, Tag = _addDefaultProps$tag === void 0 ? "div" : _addDefaultProps$tag, _addDefaultProps$base = _addDefaultProps.baseClass, baseClass = _addDefaultProps$base === void 0 ? "fade" : _addDefaultProps$base, _addDefaultProps$base2 = _addDefaultProps.baseClassActive, baseClassActive = _addDefaultProps$base2 === void 0 ? "show" : _addDefaultProps$base2, className = _addDefaultProps.className, cssModule = _addDefaultProps.cssModule, children2 = _addDefaultProps.children, _addDefaultProps$inne = _addDefaultProps.innerRef, innerRef = _addDefaultProps$inne === void 0 ? ref : _addDefaultProps$inne, otherProps = _objectWithoutProperties22(_addDefaultProps, _excluded22);
  var transitionProps = pick(_objectSpread7({
...
function UncontrolledAccordion(_ref) {
  ...
  return import_react35.default.createElement(Accordion_default, _extends26({}, _objectSpread8({
    tag: "div"
  }, props), {
    open,
    toggle: toggle2
...
var propTypes28 = _objectSpread9(_objectSpread9({}, Transition_default.propTypes), {}, {
...
var defaultProps5 = _objectSpread9(_objectSpread9({}, Transition_default.defaultProps), {}, {
  horizontal: false,
  isOpen: false,
  appear: false,
  enter: true,
...
var transitionStatusToClassHash = (_transitionStatusToCl = {}, _defineProperty13(_transitionStatusToCl, TransitionStatuses.ENTERING, "collapsing"), _defineProperty13(_transitionStatusToCl, TransitionStatuses.ENTERED, "collapse show"), _defineProperty13(_transitionStatusToCl, TransitionStatuses.EXITING, "collapsing"), _defineProperty13(_transitionStatusToCl, TransitionStatuses.EXITED, "collapse"), _transitionStatusToCl);
  ...
  _createClass6(Collapse2, [{
    ...
    value: function render() {
      ...
      return import_react38.default.createElement(Transition_default, _extends29({}, transitionProps, {
        ...
        var style = dimension === null ? null : _defineProperty13({}, horizontal ? "width" : "height", dimension);
        return import_react38.default.createElement(Tag, _extends29({}, childProps, {
          style: _objectSpread9(_objectSpread9({}, childProps.style), style),
          className: classes,
          ref: _this2.nodeRef
        }), children2);
      });
...
CarouselItem.propTypes = _objectSpread10(_objectSpread10({}, Transition_default.propTypes), {}, {
  tag: tagPropType,
...
CarouselItem.defaultProps = _objectSpread10(_objectSpread10({}, Transition_default.defaultProps), {}, {
...
var defaultProps7 = {
  ...
  onClosed: noop2,
  fade: true,
  transition: _objectSpread11({}, Fade_default.defaultProps)
};
var PopperContent = function(_React$Component) {
  ...
  _createClass10(PopperContent2, [{
    ...
    value: function renderChildren() {
      ...
      var popperTransition = _objectSpread11(_objectSpread11(_objectSpread11({}, Fade_default.defaultProps), transition), {}, {
...
UncontrolledPopover.propTypes = _objectSpread12({
...
function Progress(props) {
  ...
  var progressBarProps = {
    ...
    style: _objectSpread13(_objectSpread13(_objectSpread13({}, bar ? style : {}), barStyle), {}, {
  ...
  _createClass14(Modal2, [{
    ...
    value: function renderModalDialog() {
      ...
      return import_react69.default.createElement("div", _extends57({}, attributes, {
        className: mapToCssModules((0, import_classnames52.default)(dialogBaseClass, this.props.className, (_classNames = {}, _defineProperty18(_classNames, "modal-".concat(this.props.size), this.props.size), _defineProperty18(_classNames, "".concat(dialogBaseClass, "-centered"), this.props.centered), _defineProperty18(_classNames, "".concat(dialogBaseClass, "-scrollable"), this.props.scrollable), _defineProperty18(_classNames, "modal-fullscreen", this.props.fullscreen === true), _defineProperty18(_classNames, "modal-fullscreen-".concat(this.props.fullscreen, "-down"), typeof this.props.fullscreen === "string"), _classNames)), this.props.cssModule),
        role: "document",
        ref: function ref(c) {
          _this3._dialog = c;
        }
    ...
    value: function render() {
      ...
      if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
        ...
        var modalTransition = _objectSpread14(_objectSpread14(_objectSpread14({}, Fade_default.defaultProps), this.props.modalTransition), {}, {
...
function Tooltip(props) {
  ...
  var _props = addDefaultProps(defaultProps11, props);
  return import_react73.default.createElement(TooltipPopoverWrapper_default, _extends61({}, _props, {
    arrowClassName: arrowClasses,
    popperClassName: popperClasses,
    innerClassName: classes
  }));
...
function Label(props) {
  ...
  widths.forEach(function(colWidth, i) {
    ...
    if (isObject(columnProp)) {
      ...
      colClasses.push(mapToCssModules((0, import_classnames65.default)((_classNames = {}, _defineProperty19(_classNames, colClass, columnProp.size || columnProp.size === ""), _defineProperty19(_classNames, "order".concat(colSizeInterfix).concat(columnProp.order), columnProp.order || columnProp.order === 0), _defineProperty19(_classNames, "offset".concat(colSizeInterfix).concat(columnProp.offset), columnProp.offset || columnProp.offset === 0), _classNames))), cssModule);
    } else {
  ...
  _createClass17(Offcanvas2, [{
    ...
    value: function render() {
      ...
      if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
        ...
        var hasTransition = this.props.fade;
        var offcanvasTransition = _objectSpread15(_objectSpread15(_objectSpread15({}, Fade_default.defaultProps), this.props.offcanvasTransition), {}, {
        ...
        var backdropTransition = _objectSpread15(_objectSpread15(_objectSpread15({}, Fade_default.defaultProps), this.props.backdropTransition), {}, {
          baseClass: hasTransition ? this.props.backdropTransition.baseClass : "",
          timeout: hasTransition ? this.props.backdropTransition.timeout : 0
        });
...
function Pagination(props) {
  ...
  var listClasses = mapToCssModules((0, import_classnames70.default)(listClassName, "pagination", _defineProperty21({}, "pagination-".concat(size), !!size)), cssModule);
...
function Alert(props) {
  ...
  var alertTransition = _objectSpread16(_objectSpread16(_objectSpread16({}, Fade_default.defaultProps), transition), {}, {
    baseClass: fade ? transition.baseClass : "",
    timeout: fade ? transition.timeout : 0
  });
...
function Toast(props) {
  ...
  var toastTransition = _objectSpread17(_objectSpread17(_objectSpread17({}, Fade_default.defaultProps), transition), {}, {
    baseClass: fade ? transition.baseClass : "",
    timeout: fade ? transition.timeout : 0
  });
...
UncontrolledButtonDropdown.propTypes = _objectSpread18({
...
UncontrolledDropdown.propTypes = _objectSpread19({
...
UncontrolledTooltip.propTypes = _objectSpread20({
...
var propTypes86 = _objectSpread21(_objectSpread21({}, Col_default.propTypes), {}, {
...
function PlaceholderButton(props) {
  ...
  var _getColumnClasses = getColumnClasses(_objectSpread22({
    color: "primary"
  }, attributes), cssModule), modifiedAttributes = _getColumnClasses.modifiedAttributes, colClasses = _getColumnClasses.colClasses;
