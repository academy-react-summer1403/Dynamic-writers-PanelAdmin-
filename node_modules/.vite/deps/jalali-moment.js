...
var require_jalali_moment = __commonJS({
  "node_modules/jalali-moment/jalali-moment.js"(exports, module) {
    ...
    jMoment.fn.year = function(input) {
      if (isJalali(this))
        return jMoment.fn.jYear.call(this, input);
      else
    ...
    jMoment.fn.month = function(input) {
      if (isJalali(this))
        return jMoment.fn.jMonth.call(this, input);
      else
    ...
    jMoment.fn.date = function(input) {
      if (isJalali(this))
        return jMoment.fn.jDate.call(this, input);
      else
    ...
    jMoment.fn.dayOfYear = function(input) {
      if (isJalali(this))
        return jMoment.fn.jDayOfYear.call(this, input);
      else
    ...
    jMoment.fn.week = function(input) {
      if (isJalali(this))
        return jMoment.fn.jWeek.call(this, input);
      else
    ...
    jMoment.fn.weekYear = function(input) {
      if (isJalali(this))
        return jMoment.fn.jWeekYear.call(this, input);
      else
