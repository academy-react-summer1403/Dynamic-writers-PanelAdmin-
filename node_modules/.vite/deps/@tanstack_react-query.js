...
function createRetryer(config) {
  ...
  const run = () => {
    ...
    Promise.resolve(promiseOrValue).then(resolve).catch((error) => {
      ...
      const retry = (_a12 = config.retry) != null ? _a12 : isServer ? 0 : 3;
      const retryDelay = (_b = config.retryDelay) != null ? _b : defaultRetryDelay;
...
var Query = (_a4 = class extends Removable {
  constructor(config) {
    ...
    this.state = (_a12 = config.state) != null ? _a12 : __privateGet(this, _initialState);
    this.scheduleGc();
  }
  get meta() {
    ...
    switch (action.type) {
      ...
      case "fetch":
        return {
          ...
          fetchMeta: (_a12 = action.meta) != null ? _a12 : null
        };
      case "success":
        return {
          ...state,
...
var QueryCache = (_a5 = class extends Subscribable {
  ...
  build(client, options, state) {
    ...
    const queryHash = (_a12 = options.queryHash) != null ? _a12 : hashQueryKeyByOptions(queryKey, options);
...
var Mutation = (_a6 = class extends Removable {
  ...
  continue() {
    var _a12, _b;
    return (_b = (_a12 = __privateGet(this, _retryer2)) == null ? void 0 : _a12.continue()) != null ? _b : this.execute(this.state.variables);
  }
  async execute(variables) {
    var _a12, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u;
    __privateSet(this, _retryer2, createRetryer({
      ...
      retry: (_a12 = this.options.retry) != null ? _a12 : 0,
...
var MutationCache = (_a7 = class extends Subscribable {
  ...
  add(mutation) {
    ...
    const mutations = (_a12 = __privateGet(this, _mutations).get(scope)) != null ? _a12 : [];
...
function scopeFor(mutation) {
  var _a12, _b;
  return (_b = (_a12 = mutation.options.scope) == null ? void 0 : _a12.id) != null ? _b : String(mutation.mutationId);
}
    ...
    onFetch: (context, query) => {
      ...
      const fetchFn = async () => {
        ...
        if (direction && oldPages.length) {
          ...
          do {
            const param = currentPage === 0 ? (_a13 = oldPageParams[0]) != null ? _a13 : options.initialPageParam : getNextPageParam(options, result);
...
var QueryClient = (_a8 = class {
  ...
  invalidateQueries(filters = {}, options = {}) {
    return notifyManager.batch(() => {
      ...
      const refetchFilters = {
        ...filters,
        type: (_b = (_a12 = filters.refetchType) != null ? _a12 : filters.type) != null ? _b : "active"
      };
      return this.refetchQueries(refetchFilters, options);
    });
  }
  refetchQueries(filters = {}, options) {
    ...
    const fetchOptions = {
      ...options,
      cancelRefetch: (_a12 = options == null ? void 0 : options.cancelRefetch) != null ? _a12 : true
    };
    const promises = notifyManager.batch(
...
var QueryObserver = (_a9 = class extends Subscribable {
  ...
  fetch(fetchOptions) {
    ...
    return __privateMethod(this, _executeFetch, executeFetch_fn).call(this, {
      ...fetchOptions,
      cancelRefetch: (_a12 = fetchOptions.cancelRefetch) != null ? _a12 : true
    }).then(() => {
      this.updateResult();
      return __privateGet(this, _currentResult);
    });
  ...
  var _a12;
  return (_a12 = typeof this.options.refetchInterval === "function" ? this.options.refetchInterval(__privateGet(this, _currentQuery)) : this.options.refetchInterval) != null ? _a12 : false;
...
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  getOptimisticResult(queries, combine) {
    ...
    return [
      result,
      (r) => {
        return __privateMethod(this, _combineResult, combineResult_fn).call(this, r != null ? r : result, combine);
      },
      () => {
...
}, _client2 = new WeakMap(), _result = new WeakMap(), _queries2 = new WeakMap(), _options = new WeakMap(), _observers2 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _combineResult = new WeakSet(), combineResult_fn = function(input, combine) {
  if (combine) {
  ...
  queries.forEach((options) => {
    ...
    if (match) {
      ...
      observers.push({
        defaultedQueryOptions: defaultedOptions,
        observer: existingObserver != null ? existingObserver : new QueryObserver(__privateGet(this, _client2), defaultedOptions)
      });
    }
  });
...
var MutationObserver = (_a11 = class extends Subscribable {
  ...
  var _a12, _b;
  const state = (_b = (_a12 = __privateGet(this, _currentMutation)) == null ? void 0 : _a12.state) != null ? _b : getDefaultState2();
...
function dehydrate(client, options = {}) {
  ...
  const filterMutation = (_c = (_b = options.shouldDehydrateMutation) != null ? _b : (_a12 = client.getDefaultOptions().dehydrate) == null ? void 0 : _a12.shouldDehydrateMutation) != null ? _c : defaultShouldDehydrateMutation;
  const mutations = client.getMutationCache().getAll().flatMap(
    (mutation) => filterMutation(mutation) ? [dehydrateMutation(mutation)] : []
  );
  const filterQuery = (_f = (_e = options.shouldDehydrateQuery) != null ? _e : (_d = client.getDefaultOptions().dehydrate) == null ? void 0 : _d.shouldDehydrateQuery) != null ? _f : defaultShouldDehydrateQuery;
  const serializeData = (_i = (_h = options.serializeData) != null ? _h : (_g = client.getDefaultOptions().dehydrate) == null ? void 0 : _g.serializeData) != null ? _i : defaultTransformerFn;
...
function hydrate(client, dehydratedState, options) {
  ...
  const deserializeData = (_d = (_c = (_a12 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _a12.deserializeData) != null ? _c : (_b = client.getDefaultOptions().hydrate) == null ? void 0 : _b.deserializeData) != null ? _d : defaultTransformerFn;
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  if (defaultedOptions.experimental_prefetchInRender && !isServer && willFetch(result, isRestoring)) {
    const promise = isNewCacheEntry ? fetchOptimistic(defaultedOptions, observer, errorResetBoundary) : (_e = client.getQueryCache().get(defaultedOptions.queryHash)) == null ? void 0 : _e.promise;
