...
import { AddAssistant } from '../../core/Services/api/Assistants/AddAssistant'


const ModalAddAssistant = ({ show, setShow, refetch, courseId }) => {
    ...
    const response = await AddAssistant(dataObj)
...
export default ModalAddAssistant
