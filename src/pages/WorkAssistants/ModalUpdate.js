    ...
    const SignupSchema = yup.object().shape({
      ...
      const onSubmit = async data => {
        const dataObj = {
            ...
            id: selectedAssistant.workId
          }

        const response = await UpdateWorkAssistant(dataObj)
            ...
            <Row>
              <Col lg='12' className='mb-1'>
                ...
                <Controller
                  id='worktitle'
                  name='worktitle'
                  defaultValue={selectedAssistant.worktitle}
                  control={control}
              ...
              <Col lg='12' className='mb-1'>
                ...
                <Controller
                  id='workDescribe'
                  name='workDescribe'
                  defaultValue={selectedAssistant.workDescribe}
                  control={control}
